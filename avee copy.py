...
ret = clip.SetProperty("ZoomX", 2.35) #2.35 if source is 1080p, 1.4-1.5 if 1920x1920
...
time.sleep(0.2)
#textp.Size =  0.055 #at 1080p 0.055 #at 1920x1920 0.08
...
textp.Size[0] =  0.050 #at 1080p 0.055 #at 1920x1920 0.08
t_size = textp.Size[0]
...
#     return False
project.SetRenderSettings({"SelectAllFrames" : 1, "TargetDir" : input_f.out_fld, "CustomName": f"{input_f.basename}_dav.mp4"})
